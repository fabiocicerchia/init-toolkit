...
RUN apk add --no-cache curl=8.22.0-r0 ca-certificates=20260909-r0 tar=1.35-r5
...
RUN apk add --no-cache bash=5.3.9-r1 curl=8.22.0-r0 netcat-openbsd=1.234.1-r0 ca-certificates=20260909-r0 \
